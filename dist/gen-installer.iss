...
Source: "C:\dev\exvim\build\exvim-v0.4.1\.vimrc*"; DestDir: "{app}"; Flags: ignoreversion 
Source: "C:\dev\exvim\build\exvim-v0.4.1\vimfiles\*"; DestDir: "{app}\vimfiles"; Flags: ignoreversion recursesubdirs createallsubdirs
