...
Source: "C:\dev\exvim\build\exvim-v0.4.0\.vimrc*"; DestDir: "{app}"; Flags: ignoreversion 
Source: "C:\dev\exvim\build\exvim-v0.4.0\vimfiles\*"; DestDir: "{app}\vimfiles"; Flags: ignoreversion recursesubdirs createallsubdirs
